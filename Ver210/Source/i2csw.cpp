...
#else
  RCC->APB1ENR |= RCC_APB1ENR_TIM4EN;  //включение тактирования TIM4
  TIM4->PSC = 0;                       //загрузка прескалера
  TIM4->ARR = UINT16_MAX;              //период
  TIM4->CR1 = TIM_CR1_CEN;             //разрешение таймера
#endif
